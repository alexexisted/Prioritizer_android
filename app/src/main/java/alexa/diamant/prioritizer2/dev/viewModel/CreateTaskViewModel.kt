...
class CreateTaskViewModel @Inject constructor(
    ...
    fun calculatePriority(deadline: String, urgency: Int, importance: Int): Int {
    ...
    private fun setPriority() {
        _uiState.update {
            it.copy(
                priority = calculatePriority(_uiState.value.deadline, _uiState.value.urgency, _uiState.value.importance)
            )
        }
    }
